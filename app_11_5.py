# ===================================================================
# GEOPORTAL WEB - VERSIÓN 11.6 (AISLAMIENTO TOTAL DE MÓDULOS)
# Novedades: 
# 1. Separación absoluta de variables de estado (State Isolation).
# 2. Los cálculos y reportes de Poligonal/Nivelación Abierta y Cerrada ya no se mezclan.
# 3. Corrección del error pd.read_json en el servidor en la nube.
# 4. Diagrama de masas interactivo y grillas Bottom-Up mantenidas.
# ===================================================================
...
def inicializar_variables_proyecto():
    """Asigna valores iniciales limpios. AISLAMIENTO TOTAL de variables de cálculo."""
    defaults = {
        "modo_app": "Inicio", 
