...
def preambulo_v2(ruta_logo="Iconos/logo_geopol.png", babel_opciones="spanish,es-tabla",
    ...
    # Busca las imágenes en el propio directorio del .tex y en figuras/.
    # pdflatex debe ejecutarse con cwd=<directorio_salida> (ver
    # compilar_latex_a_pdf) para que estas rutas relativas resuelvan.
